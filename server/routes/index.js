...
module.exports = function (api, passport) {
  ...
  router.get("/GetCLMSHistoryData", async (req, res) => {
    console.log("getCLMSHistoryData Triggered");
    await home.GetCLMSHistoryData();
    // return res.json(results);
  });

  router.get("/GetCLMSHistoryData_AH2", async (req, res) => {
    console.log("getCLMSHistoryData_AH2 Triggered");
    await home.GetCLMSHistoryData_AH2();
    // return res.json(results);
  });

  router.get("/getAh2Data", async (req, res) => {
    console.log("getAh2Data Triggered");
    let results = await home.GetAh2Data();
    return res.json(results);
  });
